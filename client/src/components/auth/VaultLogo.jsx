    ...
    <svg className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <defs>
        <linearGradient id={gradId} x1="8" y1="4" x2="32" y2="36" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="0.5" stopColor="rgb(var(--color-primary))" stopOpacity="0.85" />
          <stop offset="1" stopColor="rgb(var(--color-primary))" stopOpacity="0.7" />
        </linearGradient>
      </defs>
      <rect width="40" height="40" rx="10" fill="rgb(var(--color-elevated))" />
      <path
