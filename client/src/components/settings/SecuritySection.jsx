    ...
    <div className="p-6 rounded-xl bg-white/[0.03] border border-white/[0.08]">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <Link
            to="/forgot-password"
            className="px-4 py-2 rounded-lg bg-white/10 border border-white/10 text-white text-sm hover:bg-white/20 transition-all"
          >
            Change
          </Link>
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <button
            disabled
            className="px-4 py-2 rounded-lg bg-white/5 text-gray-500 text-sm cursor-not-allowed"
          >
            Coming Soon
          </button>
        </div>
